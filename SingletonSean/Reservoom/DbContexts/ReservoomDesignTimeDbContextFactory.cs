...
namespace Reservoom.DbContexts
{
    public class ReservoomDesignTimeDbContextFactory : IDesignTimeDbContextFactory<ReservoomDbContext>
    {
        ...
        {
            DbContextOptions options = new DbContextOptionsBuilder().UseSqlServer("Data Source=ODEGAARD\\SQLEXPRESS;Initial Catalog=Sala;Integrated Security=True;Trust Server Certificate=True").Options;
