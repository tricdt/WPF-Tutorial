...
namespace DevExpress.Xpf.DemoBase.Helpers {
	public static class DangerousHelper {
		static readonly FieldInfo parentField = typeof(FrameworkElement).GetField("_parent", BindingFlags.Instance | BindingFlags.NonPublic);
