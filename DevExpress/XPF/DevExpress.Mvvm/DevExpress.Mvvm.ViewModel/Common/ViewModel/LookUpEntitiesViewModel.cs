...
namespace DevExpress.Mvvm.ViewModel {
	public class LookUpEntitiesViewModel<TEntity, TProjection, TPrimaryKey, TUnitOfWork> : EntitiesViewModelBase<TEntity, TProjection, TUnitOfWork>, IDocumentContent
		where TEntity : class
		...
		protected LookUpEntitiesViewModel(
			...
			) : base(unitOfWorkFactory, getRepositoryFunc, projection, UnitOfWorkPolicy.Individual) {
		}
