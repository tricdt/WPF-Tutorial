...
namespace DevExpress.Mvvm.DataAnnotations {
	...
	public static class PropertyMetadataBuilderExtensions {
		...
		public static PropertyMetadataBuilder<T, ICollection<TItem>> NewItemInitializer<T, TItem, TValue>(this PropertyMetadataBuilder<T, ICollection<TItem>> builder, Func<TValue> createDelegate, string name = null, string description = null) {
			return builder.InitializerCore(createDelegate, name, description, (t, n, d, c) => new NewItemInstanceInitializerAttribute(t, n, d, c));
		}
		public static PropertyMetadataBuilder<T, List<TItem>> NewItemInitializer<T, TItem, TValue>(this PropertyMetadataBuilder<T, List<TItem>> builder, Func<TValue> createDelegate, string name = null, string description = null) {
			return builder.InitializerCore(createDelegate, name, description, (t, n, d, c) => new NewItemInstanceInitializerAttribute(t, n, d, c));
		}
		public static PropertyMetadataBuilder<T, HashSet<TItem>> NewItemInitializer<T, TItem, TValue>(this PropertyMetadataBuilder<T, HashSet<TItem>> builder, Func<TValue> createDelegate, string name = null, string description = null) {
			return builder.InitializerCore(createDelegate, name, description, (t, n, d, c) => new NewItemInstanceInitializerAttribute(t, n, d, c));
		}
		public static PropertyMetadataBuilder<T, Dictionary<TKey, TValue>> NewItemInitializer<T, TKey, TValue, TNewItem>(this PropertyMetadataBuilder<T, Dictionary<TKey, TValue>> builder, Func<ITypeDescriptorContext, IDictionary<TKey, TValue>, KeyValuePair<TKey, TNewItem>> createDelegate, string name = null, string description = null) where TNewItem : TValue {
			return builder.InitializerCore(createDelegate, name, description, (t, n, d, c) => new NewItemInstanceInitializerAttribute(t, n, d, (context, dictionary) => {
				var x = c(context, (Dictionary<TKey, TValue>)dictionary);
				return (KeyValuePair<object, object>?)new KeyValuePair<object, object>(x.Key, x.Value);
			}));
		}
		public static PropertyMetadataBuilder<T, IDictionary<TKey, TValue>> NewItemInitializer<T, TKey, TValue, TNewItem>(this PropertyMetadataBuilder<T, IDictionary<TKey, TValue>> builder, Func<ITypeDescriptorContext, IDictionary<TKey, TValue>, KeyValuePair<TKey, TNewItem>> createDelegate, string name = null, string description = null) where TNewItem : TValue {
			return builder.InitializerCore(createDelegate, name, description, (t, n, d, c) => new NewItemInstanceInitializerAttribute(t, n, d, (context, dictionary) => {
				var x = c(context, (IDictionary<TKey, TValue>)dictionary);
				return (KeyValuePair<object, object>?)new KeyValuePair<object, object>(x.Key, x.Value);
			}));
		}
		public static PropertyMetadataBuilder<T, IDictionary> NewItemInitializer<T, TNewItem>(this PropertyMetadataBuilder<T, IDictionary> builder, Func<ITypeDescriptorContext, IDictionary, KeyValuePair<object, TNewItem>> createDelegate, string name = null, string description = null) {
			return builder.InitializerCore(createDelegate, name, (t, n, c) => new NewItemInstanceInitializerAttribute(t, n, description, (context, dictionary) => {
				var x = c(context, (IDictionary)dictionary);
...
#region date time
		...
		public static FilteringPropertyMetadataBuilder<T, ICollection<TItem>> NewItemInitializer<T, TItem, TValue>(this FilteringPropertyMetadataBuilder<T, ICollection<TItem>> builder, Func<TValue> createDelegate, string name = null, string description = null) {
			return builder.InitializerCore(createDelegate, name, description, (t, n, d, c) => new NewItemInstanceInitializerAttribute(t, n, d, c));
		}
#endif
	}
