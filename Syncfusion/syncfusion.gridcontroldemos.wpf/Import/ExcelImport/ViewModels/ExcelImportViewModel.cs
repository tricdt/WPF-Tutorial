...
{
    public class ExcelImportViewModel : NotificationObject
    {
        #region Fields

        private IExcelImport mainView;
        ...
        private void Initialize()
        {
            ...
            if (MainView.GetType().ToString() == "syncfusion.gridcontroldemos.wpf.ExcelImport")
            {
                FileStream fileStream = new FileStream(@"Data\GridControl\Sample.xlsx", FileMode.Open);
