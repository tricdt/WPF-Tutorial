...
{
    /// <summary>
    /// Interaction logic for GridControlSelection.xaml
    /// </summary>
    public partial class GridControlSelection : DemoControl
    {
        public GridControlSelection()
        {
            InitializeComponent();
            GridSettings();
        }
        public GridControlSelection(string themename) : base(themename)
        {
            InitializeComponent();
            GridSettings();
        }
