...
namespace syncfusion.gridcontroldemos.wpf
{
    ...
    /// </summary>
    public partial class ExcelExport : DemoControl, IExcelExport
    {
        public ExcelExport()
        {
            InitializeComponent();
            this.DataContext = new ExcelExportViewModel(this);
        }

        public ExcelExport(string themename) : base(themename)
        {
            InitializeComponent();
            this.DataContext = new ExcelExportViewModel(this);
        }
        ...
        public void ExportSelectedRange()
        {
            ...
            if (rangeList.Count > 0)
            {
                ...
                try
                {
                    ...
                    excelEngine.Dispose();
                    System.Diagnostics.ProcessStartInfo info = new System.Diagnostics.ProcessStartInfo("Sample.xlsx");
                    info.UseShellExecute = true;
                    System.Diagnostics.Process.Start(info);
