...
{
    /// <summary>
    /// Interaction logic for RichTextBoxCell.xaml
    /// </summary>
    public partial class RichTextBoxCell : DemoControl
    {
        ...
        public RichTextBoxCell(string themename) : base(themename)
        {
            InitializeComponent();
            InitGrid();
            SetRowHeightColumnWidth();
        ...
        private void InitGrid()
        {
            ...
            this.grid.Model.TableStyle.HorizontalAlignment = HorizontalAlignment.Left;
            this.grid.Model.TableStyle.VerticalAlignment = VerticalAlignment.Center;
            this.grid.Model.ColStyles[3].HorizontalAlignment = HorizontalAlignment.Left;
    ...
    public partial class MailDataCollection : ObservableCollection<MailData>
    {
        ...
        public MailDataCollection()
        {
            ...
            foreach (OutlookData outlookData in Outlookcontent)
            {
                ...
                if (data.Important)
                {
                    BitmapImage bi = new BitmapImage(new Uri(@"pack://application:,,,/syncfusion.gridcontroldemos.wpf;component/Assets/GridControl/RichTextBoxCell/Important.png", UriKind.Absolute));
                ...
                image2.Source = data.IsRead ? new BitmapImage(new Uri(@"pack://application:,,,/syncfusion.gridcontroldemos.wpf;component/Assets/GridControl/RichTextBoxCell/ReadMail.png", UriKind.Absolute)) : new BitmapImage(new Uri(@"pack://application:,,,/syncfusion.gridcontroldemos.wpf;component/Assets/GridControl/RichTextBoxCell/UnreadMail.png", UriKind.Absolute));
                ...
                image3.Source = data.Flagged ? new BitmapImage(new Uri(@"pack://application:,,,/syncfusion.gridcontroldemos.wpf;component/Assets/GridControl/RichTextBoxCell/Flagged.png", UriKind.Absolute)) : new BitmapImage(new Uri(@"pack://application:,,,/syncfusion.gridcontroldemos.wpf;component/Assets/GridControl/RichTextBoxCell/UnFlagged.png", UriKind.Absolute));
