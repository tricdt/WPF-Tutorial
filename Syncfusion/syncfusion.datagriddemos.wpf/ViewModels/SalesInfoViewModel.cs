...
{
    public class SalesInfoViewModel : NotificationObject, IDisposable
    {
        ...
        public ObservableCollection<SalesByDate> GetSalesInfo()
        {
            ...
            while (i < 60)
            {
                ...
                salesByYear.Total = salesByYear.QS1 + salesByYear.QS2 + salesByYear.QS3 + salesByYear.QS4;
                salesByYear.TotalSales = salesByYear.QS1 + salesByYear.QS2 + salesByYear.QS3 + salesByYear.QS4 + salesByYear.QS5 + salesByYear.QS6;
        ...
        public void Dispose()
        {
            ...
            {
                this._SalesDetails.Clear();
                this._SalesDetails = null;
            }

            if (YearlySalesDetails != null)
            {
                this.YearlySalesDetails.Clear();
            }
        }
