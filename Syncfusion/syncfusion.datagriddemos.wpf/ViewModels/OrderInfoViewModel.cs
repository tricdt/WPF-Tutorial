    ...
    public class OrderInfoViewModel : NotificationObject, IDisposable
    {
        ...
        private void PopulateData()
        {
            for (int i = 0; i < 100; i++)
            {
                ...
                orderInfo.Product = (i == 10 || i == 20) ? null : ProductName[r.Next(0, 47)];
                ...
                orderInfo.OrderDate = DateTime.Today.AddDays(r.Next(-50, 1));
                orderInfo.ShippedDate = DateTime.Today.AddDays(r.Next(-50, 1));
                orderInfo.Date = (i == 5 || i == 15) ? dateValue : DateTime.Today.AddDays(r.Next(-50, 1));
