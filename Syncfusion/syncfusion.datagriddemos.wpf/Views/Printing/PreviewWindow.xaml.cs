...
namespace syncfusion.datagriddemos.wpf
{
    ...
    public partial class PreviewWindow : Window
    {
        ...
        private void OnMarginCmbBoxSelectionChanged(object sender, System.Windows.Controls.SelectionChangedEventArgs e)
        {
            if (printDataContext == null) return;
            double left = 0;
            double right = 0;
        ...
        private void OnPageSizeOkButtonClick(object sender, RoutedEventArgs e)
        {
