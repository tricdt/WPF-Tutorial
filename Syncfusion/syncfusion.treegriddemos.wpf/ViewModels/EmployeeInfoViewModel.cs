...
namespace syncfusion.treegriddemos.wpf
{
    public class EmployeeInfoViewModel : NotificationObject, IDisposable
    {
            ...
            if (count > 0)
            {
                for (int i = 0; i < count; i++)
                {
                    ...
                    personList.Add(new EmployeeInfo()
                    {
                        ...
                        Hike = random.Next(5, 15),
                        ContactNumber = 9991121234 + i,
                        DOJ = new DateTime(random.Next(2008, 2012), random.Next(1, 12), random.Next(1, 28)),
                        JoiningDate = (i == 4) ? dateValue : new DateTime(random.Next(2008, 2012), random.Next(1, 12), random.Next(1, 28)),
        ...
        public void Dispose()
        {
            ...
            if (this.EmployeesListInfo != null)
            {
                this.EmployeesListInfo.Clear();
                this.EmployeesListInfo = null;
            }
